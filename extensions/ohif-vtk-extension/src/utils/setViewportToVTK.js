...
export default function setViewportToVTK (displaySet, viewportIndex, layout, viewportSpecificData) {
  return new Promise((resolve, reject) => {
    ...
    setLayoutAndViewportData({ viewports: updatedViewports }, updatedViewportData);
  });
}
