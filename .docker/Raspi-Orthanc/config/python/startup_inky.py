...
startup_message = """Connect with the WIFI network 'MobileSwoop'. 

After a study has been sent a QR code will appear.
"""

import pdb; pdb.set_trace()
while not below_max_length:
    
    reflowed = reflow_quote(startup_message, max_width, quote_font)
